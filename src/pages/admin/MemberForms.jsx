...
const MemberForms = ({ view }) => {
  ...
  return (
    <div>
      ...
      <form className='p-5 bg-customgray1 flex flex-col gap-4 xl:grid xl:grid-cols-3 xl:p-8 xl:gap-7' onSubmit={handleUpdates}>
        <div className='flex flex-col gap-4 xl:col-start-1'>
          ...
          <div className='bg-white p-5 flex flex-col rounded-md font-poppins font-normal'>
            ...
            <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Last Name" type="text" name="" id="" disabled={!isEdit} required value={memberData?.last_name || ""}
              onChange={e => setMemberData({ ...memberData, last_name: e.target.value })} />

            <label htmlFor="firstname">First Name</label>
            <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="First Name" type="text" name="" id="" disabled={!isEdit} required value={memberData?.first_name || ""}
              onChange={e => setMemberData({ ...memberData, first_name: e.target.value })} />

            <label htmlFor="middlename">Middle Name</label>
            <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Middle Name" type="text" name="" id="" disabled={!isEdit} required value={memberData?.middle_name || ""}
            ...
            <div className='flex justify-between gap-4'>
              <div className='flex flex-col w-1/2'>
                ...
                <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="00" type="number" name="" id="" value={allDetails?.age || ""} readOnly />
              </div>

              <div className='flex flex-col w-1/2 relative'>
                <label htmlFor="gender">Gender</label>
                <select name="" id="" required disabled={!isEdit} value={memberData?.gender || ""} onChange={(e) => setMemberData({ ...memberData, gender: e.target.value })} className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm">
            ...
            <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Position" type="text" name="" id="" disabled={!isEdit} required value={familyData?.head_position || ""} onChange={e => setFamilyData({ ...familyData, head_position: e.target.value })} />

            <label htmlFor="contact">Contact Number</label>
            <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Contact Number" type="number" name="" id="" disabled={!isEdit} required value={memberData?.contact_number || ""} onChange={e => setMemberData({ ...memberData, contact_number: e.target.value })} />
          </div>

          <div className='bg-white p-5 flex flex-col rounded-md font-poppins font-normal'>
            <label htmlFor="tct">TCT No.</label>
            <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="TCT Number" type="text" name="" id="" disabled={!isEdit} required value={householdData?.tct_no || ""} onChange={e => setHouseholdData({ ...householdData, tct_no: e.target.value })} />

            <div className='flex justify-between gap-4'>
              <div className='flex flex-col w-1/2'>
                <label htmlFor="block">Block No.</label>
                <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Block Number" type="number" name="" id="" disabled={!isEdit} required value={householdData?.block_no || ""} onChange={e => setHouseholdData({ ...householdData, block_no: e.target.value })} />
              </div>

              <div className='flex flex-col w-1/2'>
                <label htmlFor="lot">Lot No.</label>
                <input className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Lot Number" type="number" name="" id="" disabled={!isEdit} required value={householdData?.lot_no || ""} onChange={e => setHouseholdData({ ...householdData, lot_no: e.target.value })} />
              </div>
            </div>
                ...
                return (
                  <AccordionItem key={key} value={`member-${key}`}>
                    ...
                    <AccordionContent className="flex flex-col bg-white px-5 pb-5 font-poppins rounded-b-sm">
                      ...
                      <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm mb-3" placeholder="Last Name" type="text" name="" id="" disabled={!isEdit} required value={member?.last_name || ""} onChange={e => handleFamilyMemberChange(key, 'last_name', e.target.value)} />

                      <label htmlFor="famfirstname">First Name</label>
                      <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm mb-3" placeholder="First Name" type="text" name="" id="" disabled={!isEdit} required value={member?.first_name || ""} onChange={e => handleFamilyMemberChange(key, 'first_name', e.target.value)} />

                      <label htmlFor="fammiddlename">Middle Name</label>
                      <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm mb-3" placeholder="Middle Name" type="text" name="" id="" disabled={!isEdit} required value={member?.middle_name || ""} onChange={e => handleFamilyMemberChange(key, 'middle_name', e.target.value)} />

                      <label htmlFor="relation">Relation to Member</label>
                      <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm mb-3" placeholder="Relation to Member" type="text" name="" id="" disabled={!isEdit} required value={member?.relation_to_member || ""} onChange={e => handleFamilyMemberChange(key, 'relation_to_member', e.target.value)} />
                      ...
                      <div className='flex w-full justify-between gap-4'>
                        <div className='flex flex-col w-1/2'>
                          ...
                          <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm mb-3" placeholder="00" type="number" name="" id="" value={member?.age || ""} readOnly />
                        </div>

                        <div className='flex flex-col w-1/2 relative'>
                          <label htmlFor="famgender">Gender</label>
                          <select name="" id="" required disabled={!isEdit} value={member?.gender || ""} onChange={(e) => handleFamilyMemberChange(index, 'gender', e.target.value)} className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm">
                            <option value="" disabled hidden></option>
                            <option value="Male">Male</option>
                            <option value="Female">Female</option>
                            <option value="Other">Other</option>
                      ...
                      <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm mb-3" placeholder="Educational Attainment" type="text" name="" id="" disabled={!isEdit} required value={member?.educational_attainment || ""} onChange={e => handleFamilyMemberChange(key, 'educational_attainment', e.target.value)} />
        ...
        <div className='flex flex-col gap-4 xl:col-start-3'>
          ...
          <div className='bg-white p-5 flex flex-col rounded-md font-poppins font-normal'>
            ...
            <div className='relative'>
              <select name="" id="" required disabled={!isEdit} value={householdData?.condition_type || ""} onChange={(e) => setHouseholdData({ ...householdData, condition_type: e.target.value })} className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm w-full">
                <option value="" disabled hidden></option>
            ...
            <div className='relative'>
              <select name="" id="" required disabled={!isEdit} value={familyData?.land_acquisition || ""} onChange={(e) => setFamilyData({ ...familyData, land_acquisition: e.target.value })} className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm w-full">
                <option value="" disabled hidden></option>
            ...
            <div className='relative'>
              <select name="" id="" required disabled={!isEdit} value={familyData?.status_of_occupancy || ""} onChange={(e) => setFamilyData({ ...familyData, status_of_occupancy: e.target.value })} className="mb-3 bg-customgray2 py-1 px-2 text-sm rounded-sm w-full">
                <option value="" disabled hidden></option>
