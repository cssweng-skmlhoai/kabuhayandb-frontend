        ...
        <div className="flex-1 relative">
          <div className="pb-5 pt-8 px-7 flex flex-col bg-customgray1 gap-10 font-poppins h-max xl:bg-white xl:gap-0 xl:px-5 xl:pt-5">
            ...
            <div className="flex flex-col gap-11 xl:flex xl:border xl:border-black xl:mr-3 xl:mt-3 xl:mb-10 xl:rounded-lg xl:flex-col xl:px-40 xl:py-10">
              ...
              <div className="flex flex-col justify-center items-center gap-3">
                ...
                <div className="w-full flex flex-col gap-4 xl:flex-row xl:justify-between">
                  <div className="bg-customgray2 flex flex-col gap-1.5 items-center justify-center py-3 border border-black rounded-md font-medium xl:w-full">
                    ...
                    <p className="text-lg">
                      ₱{" "}
                      {parseFloat(collectionEff.total_billed).toLocaleString(
                        "en-US"
                      )}
                    </p>
                  </div>
                  <div className="bg-customgray2 flex flex-col gap-1.5 items-center justify-center py-3 border border-black rounded-md font-medium xl:w-full">
                    ...
                    <p className="text-lg">
                      ₱{" "}
                      {parseFloat(collectionEff.total_collected).toLocaleString(
                        "en-US"
                      )}
                    </p>
                  </div>
                  <div className="bg-customgray2 flex flex-col gap-1.5 items-center justify-center py-3 border border-black rounded-md font-medium xl:w-full">
                    ...
                    <p className="text-lg">
                      {parseFloat(collectionEff.efficiency).toFixed(2)}%
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="w-full overflow-auto">
                  <table className="w-full border border-black border-separate rounded-md text-center">
                    <thead className="bg-customgray2">
                      <tr>
                        <th className="border-r border-b border-black px-4 py-2 font-semibold">
                          Due Type
                        </th>
                        <th className="border-r border-b border-black px-4 py-2">
                          Total Dues
                        </th>
                        <th className="border-r border-b border-black px-4 py-2">
                          Total Amount (₱)
                        ...
                        <th className="border-b border-black px-4 py-2">
                          Unpaid Amount (₱)
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {summaryDueType.map((due) => (
                        <tr key={due.due_type}>
                          <td className="border-r border-b border-black px-4 py-2 bg-white">
                            {due.due_type}
                          </td>
                          <td className="border-r border-b border-black px-4 py-2 bg-white">
                            {Number(due.total_dues).toLocaleString("en-US")}
                          </td>
                          <td className="border-r border-b border-black px-4 py-2 bg-white">
                          ...
                          <td className="border-r border-b border-black px-4 py-2 bg-white">
                            {parseFloat(due.paid_amount).toLocaleString(
                              "en-US"
                            )}
                          </td>
                          <td className="border-b border-black px-4 py-2 bg-white">
                            {parseFloat(due.unpaid_amount).toLocaleString(
                              "en-US"
                            )}
                          </td>
                        </tr>
              ...
              <div className="flex flex-col justify-center items-center gap-3">
                <p className="font-medium text-lg">
                  Summary of Dues by Household (BLK and LOT)
                </p>
                <div className="w-full overflow-auto">
                  <table className="w-full border border-black border-separate rounded-md text-center">
                    <thead className="bg-customgray2">
                  ...
                  <table className="w-full border border-black border-separate rounded-md text-center">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border-b border-black px-4 py-2 bg-white">
                          {Number(totalUnpaid.total_unpaid_dues).toLocaleString(
                            "en-US"
                          )}
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="border-b border-black px-4 py-2 bg-white">
                          ₱{" "}
                          {parseFloat(
                            totalUnpaid.total_unpaid_amount
                      ...
                      <tr>
                        ...
                        <td className="border-b border-black px-4 py-2 bg-white">
                          {totalUnpaid.affected_households}
                        </td>
                      </tr>
                      <tr>
                        <td className="border-r border-b border-black px-4 py-2 bg-white">
                          Average Unpaid per Household
                        </td>
                        <td className="border-b border-black px-4 py-2 bg-white">
                          ₱{" "}
                          {parseFloat(
                            totalUnpaid.average_unpaid_per_household
                          ).toLocaleString("en-US")}
                        </td>
                      </tr>
                    </tbody>
