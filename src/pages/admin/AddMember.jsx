      ...
      <form className='p-5 bg-customgray1 flex flex-col gap-4 xl:grid xl:grid-cols-3 xl:p-8 xl:gap-7' onSubmit={handleSubmit}>
        ...
        <div className='flex flex-col gap-4 xl:col-start-3'>
          <div className='bg-white p-5 flex flex-col rounded-md font-poppins font-normal'>
            ...
            <input className="bg-customgray2 py-1 px-2 text-sm rounded-sm" placeholder="Remarks" type="text" name="" id="" value={memberData.remarks || ""}
          ...
          <div className='bg-white p-5 flex flex-col rounded-md font-poppins font-normal'>
            ...
            <div className='flex justify-between'>
              <div className='flex flex-col items-center mb-3 gap-1'>
                ...
                <Checkbox id="meralco" className="border bg-customgray1 size-6" checked={!!householdData.Meralco || false} onCheckedChange={(checked) => setHouseholdData({ ...householdData, Meralco: checked })} />
              </div>
